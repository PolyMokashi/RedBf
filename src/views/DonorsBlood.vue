...
export default {
  ...
  methods: {
    ...
    async donorData() {
      await axios
        .get("https://redb-backend.onrender.com/get/donors")
        .then((result) => {
    ...
    async deleteItem(item) {
      await axios
        .delete(`https://redb-backend.onrender.com/delete/donors/${item._id}`)
        .then((data) => {
          console.log(data);
        })
        .catch((err) => {
    ...
    async save() {
      await axios
        .post("https://redb-backend.onrender.com/add/new/donors", {
